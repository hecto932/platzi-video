...
/******/ 	__webpack_require__.p = "/home/hector/platzi/platzi-video/dist/";
/******/
...
(0, _reactDom.render)(_react2.default.createElement(_home2.default, { data: _api2.default }), homeContainer);
...
var _related = __webpack_require__(45);
...
var _videoPlayer = __webpack_require__(53);
...
var Home = function (_Component) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      modalVisible: false,
      media: null
    }, _this.handleOpenModal = function (media) {
      _this.setState({
        modalVisible: true,
        media: media
      });
...
var _category = __webpack_require__(32);
...
var _playlist = __webpack_require__(33);
...
function Playlist(props) {
  return _react2.default.createElement(
    ...
    props.playlist.map(function (item) {
      return _react2.default.createElement(_media2.default, _extends({ openModal: props.handleOpenModal }, item, { key: item.id }));
    })
  );
}
...
var Media = function (_PureComponent) {
  ...
  _createClass(Media, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'Media', onClick: this.handleClick },
        _react2.default.createElement(
          'div',
...
Media.propTypes = {
  ...
  type: _propTypes2.default.oneOf(['video', 'audio'])
};
...
var SearchContainer = function (_Component) {
  ...
  function SearchContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchContainer.__proto__ || Object.getPrototypeOf(SearchContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      event.preventDefault();
      console.log(_this.input.value, 'submit');
...
function Related(props) {
  return _react2.default.createElement(
    'div',
    { className: 'Related' },
    _react2.default.createElement('img', { src: _logo2.default, width: 250 })
  );
}
...
module.exports = __webpack_require__.p + "images/logo.c06f5e5a2ae47006c0b77be4de6a2077.png";
...
var _regularError = __webpack_require__(52);
...
var _videoPlayerLayout = __webpack_require__(54);

var _videoPlayerLayout2 = _interopRequireDefault(_videoPlayerLayout);
...
var _playPause = __webpack_require__(60);
...
var _videoPlayerControls = __webpack_require__(66);

var _videoPlayerControls2 = _interopRequireDefault(_videoPlayerControls);

var _utils = __webpack_require__(68);

var _progressBar = __webpack_require__(69);
...
var _volume = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/volume\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var VideoPlayer = function (_Component) {
  ...
  function VideoPlayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoPlayer.__proto__ || Object.getPrototypeOf(VideoPlayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      lastVolume: null,
      mute: false
    }, _this.togglePlay = function (event) {
      _this.setState({
        pause: !_this.state.pause
      });
    }, _this.handleLoadedMetadata = function (event) {
      _this.video = event.target;
      _this.setState({
        durationFormatted: (0, _utils.formattedTime)(_this.video.duration),
        duration: _this.video.duration
      });
    }, _this.handleTimeUpdate = function (event) {
      _this.setState({
        currentTimeFormatted: (0, _utils.formattedTime)(_this.video.currentTime),
        currentTime: _this.video.currentTime
      });
    }, _this.handleProgressChange = function (event) {
      // Cambiamos el tiempo de transcurso del video
      _this.video.currentTime = event.target.value;
    }, _this.handleSeeking = function (event) {
      _this.setState({
        loading: true
      });
    }, _this.handleSeeked = function (event) {
      _this.setState({
        loading: false
      });
    }, _this.handleVolumeChange = function (event) {
      _this.video.volume = event.target.value;
    }, _this.handleVolumeClick = function (event) {
      _this.setState({
        mute: !_this.state.mute,
        lastVolume: _this.video.volume
      });
      _this.video.volume === 0 ? _this.video.volume = _this.state.lastVolume : _this.video.volume = 0;
    }, _this.handleFullScreen = function (event) {
      if (!document.webkitIsFullScreen) {
        _this.player.webkitRequestFullScreen();
      } else {
...
var VideoPlayerLayout = function VideoPlayerLayout(props) {
  return _react2.default.createElement(
    'div',
    {
...
exports.default = VideoPlayerLayout;
...
var Video = function (_Component) {
  ...
  function Video() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Video.__proto__ || Object.getPrototypeOf(Video)).call.apply(_ref, [this].concat(args))), _this), _this.setRef = function (element) {
      _this.video = element;
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Video, [{
    ...
    value: function render() {
      var _props = this.props,
          handleLoadedMetadata = _props.handleLoadedMetadata,
          handleTimeUpdate = _props.handleTimeUpdate,
          handleProgressChange = _props.handleProgressChange,
          handleSeeking = _props.handleSeeking,
          handleSeeked = _props.handleSeeked;
...
var _pause = __webpack_require__(63);
...
function PlayPause(props) {
  return _react2.default.createElement(
    'div',
    { className: 'PlayPause' },
    props.pause ? _react2.default.createElement(
      'button',
      { onClick: props.handleClick },
      _react2.default.createElement(_play2.default, {
        size: 25,
        color: 'white'
      })
    ) : _react2.default.createElement(
...
function Pause(props) {
  return _react2.default.createElement(
    _icon2.default,
    props,
    _react2.default.createElement('path', { d: 'M4 4h10v24h-10zM18 4h10v24h-10z' })
  );
}
...
var VideoPlayerControls = function VideoPlayerControls(props) {
  return _react2.default.createElement(
    'div',
...
module.exports = {
  formattedTime: function formattedTime(secs) {
...
var _fullScreen = __webpack_require__(74);
...
var FullScreen = function FullScreen(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_fullScreen2.default, _extends({}, props, {
      size: 25,
      color: 'white'
    }))
  );
...
function FullScreen(props) {
  return _react2.default.createElement(
    _icon2.default,
    props,
    _react2.default.createElement('path', { d: 'M32 0h-13l5 5-6 6 3 3 6-6 5 5z' }),
    _react2.default.createElement('path', { d: 'M32 32v-13l-5 5-6-6-3 3 6 6-5 5z' }),
    _react2.default.createElement('path', { d: 'M0 32h13l-5-5 6-6-3-3-6 6-5-5z' }),
    _react2.default.createElement('path', { d: 'M0 0v13l5-5 6 6 3-3-6-6 5-5z' })
  );
}
